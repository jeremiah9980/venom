...
function currentTheme(){
  const saved=localStorage.getItem('venom-theme')||localStorage.getItem('texas-venom-theme');
...
loadStylesheet('assets/css/venom-ui.css?v=20260812-1');
